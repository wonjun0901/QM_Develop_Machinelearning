...
gradient_model = GradientBoostingRegressor(
    n_estimators=200, learning_rate=0.1, max_depth=2, random_state=0, loss='ls').fit(X_train, y_train)
...
predicted = gradient_model.predict(X_train)
predicted_test = gradient_model.predict(X_test)
